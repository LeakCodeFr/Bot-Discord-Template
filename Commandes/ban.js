...
module.exports = {
    ...
    async run(bot, message, args) {
        ...
        try {
            ...
            if(member && message.member.roles.highest.comparePositionTo(member.roles.highest) <= 0) return message.reply("Tu ne peux pas bannir un membre ayant un rôle supérieur au tien !")
